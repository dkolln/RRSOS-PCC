namespace RRSOS_PCC.Services
{
    ...
    /// <summary>
    /// Short flash messages that fade away on their own. One per browser session (scoped), so a toast
    /// only ever shows in the page that caused it. The fade itself is CSS; this just keeps the list and
    /// removes each toast once it has finished.
    /// </summary>
